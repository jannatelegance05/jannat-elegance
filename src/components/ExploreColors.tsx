      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        <div className="w-full lg:w-1/3 text-left space-y-4">
          ...
          <div className="pt-2">
            <Link
              href="/shop"
              className="inline-block bg-[#FFD1DC] text-[#4a0e17] font-semibold text-xs sm:text-sm uppercase tracking-wider px-8 py-3.5 shadow-md hover:bg-pink-100 transition-all duration-300"
            >
              Shop Now
            </Link>
          </div>
        ...
        <div className="w-full lg:w-2/3 grid grid-cols-3 gap-3 sm:gap-6">
          {colorCards.map((card, idx) => (
            ...
            >
              <div className="absolute inset-0 border-2 border-[#fce7f3]/30 pointer-events-none z-10 group-hover:border-[#FFD1DC] transition-colors duration-300" />
