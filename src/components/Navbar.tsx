...
return ( <header className="sticky top-0 z-50 w-full border-b border-pink-100/80 bg-[#FFD1DC]/95 shadow-[0_8px_30px_rgba(76,5,25,0.06)] backdrop-blur-xl">
    ...
    <div className="flex h-[78px] items-center justify-between gap-3 lg:h-[86px]">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2.5">
        ...
        >
          ...
          {wishlist.length > 0 && (
            <span className="absolute -right-1 -top-1 grid h-5 min-w-5 place-items-center rounded-full border-2 border-[#FFD1DC] bg-gradient-to-br from-rose-600 to-pink-500 px-1 text-[10px] font-bold text-white shadow-sm">
        ...
        >
          ...
          {cartCount > 0 && (
            <span className="absolute -right-1 -top-1 grid h-5 min-w-5 place-items-center rounded-full border-2 border-[#FFD1DC] bg-pink-500 px-1 text-[10px] font-bold text-white shadow-sm">
