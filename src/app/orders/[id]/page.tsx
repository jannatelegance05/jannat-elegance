...
// // Loading
// if (loading) {
// return ( <main className="grid min-h-[60vh] place-items-center bg-[#FFD1DC] text-sm text-gray-500">
// Loading order… </main>
// );
// }
...
// // Order Not Found
// if (!order) {
// return ( <main className="grid min-h-[60vh] place-items-center bg-[#FFD1DC]"> <div className="text-center"> <h1 className="font-serif text-3xl text-maroon-950">
// Order not found </h1>
...
// return (
// <> <main className="min-h-screen bg-[#FFD1DC] py-10 print:bg-white"> <div className="mx-auto max-w-5xl px-4 sm:px-6">
...
export default function OrderDetailsPage() {
  ...
  if (loading) {
    return (
      <main className="min-h-screen bg-[#FFD1DC] px-4 py-10 sm:px-6">
  ...
  if (error || !order) {
    return (
      <main className="grid min-h-[70vh] place-items-center bg-[#FFD1DC] px-4">
  ...
  return (
    <main className="min-h-screen bg-[#FFD1DC] px-4 py-8 sm:px-6 sm:py-12">
